...
contract FoundryPlayground is FuzzGuided {
    ...
    function test_repro_20_fuzz_guided_router7540_partialFulfill() public {
        ...
        try
            this.fuzz_admin_router4626_fulfillRedeem(
                48338929783660781,
                52670703927795634442829774399954743202977784654290543440242936378323864206838
            )
        {} catch {}
        ...
        try
            this.fuzz_merkl_claimRewards(
                61797209365707328549125443422028408119019920739501954328700437568638826446730
            )
        {} catch {}
        ...
        this.fuzz_guided_router7540_partialFulfill(
            8816526032587984106035,
            2751784041057608181650948084281963600034452847535828024138512306558464048288,
            0
        );
    }
    ...
    function test_repro_21_fuzz_admin_pool_processPendingRedemptions() public {
        ...
        try
            this.fuzz_admin_router4626_liquidate(
                946962682,
                108440753633129251720570879000087525755721336049586913605522656296343372371021
            )
        {} catch {}
        vm.warp(block.timestamp + 503086);
        vm.roll(block.number + 14099);
        try
            this.fuzz_admin_node_startRebalance(
    ...
    function test_repro_22_fuzz_guided_router7540_fulfillRedeem() public {
        ...
        try
            this.fuzz_mint(
                74972595886271919897676948109473778757826803834988643610821602922307385331036
            )
        {} catch {}
        ...
        try
            this.fuzz_admin_router4626_liquidate(
                3948763057069771832731125175262834590714745981442474909194108084588964496520,
                388172519
            )
        {} catch {}
        ...
        try
            this.fuzz_admin_router4626_invest(
                272037121,
                15594759375282051899134883350874778770391563389023855594690558986001629321183
            )
        {} catch {}
        ...
        try this.forceNodeContextForTest(0) {} catch {}
        this.fuzz_guided_router7540_fulfillRedeem(
            10554636948743835141513245061764140400635405681097233861411485154833313651639,
            712,
            149957474321084558579520
        );
    }
    ...
    function test_repro_23_fuzz_admin_router4626_invest() public {
        ...
        {} catch {}
        this.fuzz_admin_router4626_invest(
            210144308199392088329835531410517100691065813357626025480387613234992382,
            3236103678201
        );
    }
    ...
    function test_repro_24_fuzz_admin_router4626_fulfillRedeem() public {
        ...
        try
            this.fuzz_admin_router7540_requestAsyncWithdrawal(
                3693809503832468918578994684699473957406547677216879787826602939636338439892,
                1527021096
            )
        {} catch {}
        ...
        try
            this.fuzz_admin_router4626_liquidate(
                38011408696111666806885,
                28682921901818409095105767462935977389272635557194608783260227709573863234039
            )
        {} catch {}
        ...
        try
            this.fuzz_merkl_claimRewards(
                1871595335851216480705686316040362085895371260889126809614039734917317880533
            )
        {} catch {}
        ...
        try
            this.fuzz_merkl_claimRewards(
                34417326770437387383023081110741511827649882840160217839534527347028922829287
            )
        {} catch {}
        try
            this.fuzz_fluid_claimRewards(
        ...
        this.fuzz_admin_router4626_fulfillRedeem(
            74698920154011644766883164678,
            8978597624093045223803
        );
    }
    ...
    function test_repro_25_fuzz_guided_router7540_partialFulfill() public {
        try
            this.fuzz_guided_router7540_fulfillRedeem(
                2956147788029956252690560003552784044387370562664179084508016477093388059094,
                115,
                223804887795172354500404
            )
        {} catch {}
        this.fuzz_guided_router7540_partialFulfill(
            2542708026071853322418,
            4467376005286988418700395113791252604115049420001910778126340938921683439084,
            0
        );
    }
    ...
    function test_repro_26_fuzz_admin_digift_forwardRequests() public {
        try
            this.fuzz_guided_router7540_executeAsyncWithdrawal(
                0,
                5018145451792544580748153481210036,
                0
            )
        {} catch {}
    ...
    function test_repro_29_fuzz_guided_router7540_claimable() public {
        ...
        this.fuzz_guided_router7540_claimable(
            12332544016697713562781574770496414935,
            319092278233355812663502932580123998747395
        );
    }
    ...
    function test_repro_31() public {
        fuzz_admin_router7540_invest(
            2819937561830010214815101325065727293434397045408951454613418294184
        );
        fuzz_admin_wt_forwardRequests(0);
        fuzz_admin_wt_settleDeposit(5022530189214886783275133050848570970630103832101);
        fuzz_wt_mint(1);
        fuzz_admin_wt_settleRedeem(
            1651278882470732964017190147383150934884250037628298895864114045
        );
        fuzz_wt_withdraw(1031217444742601353090152427852082001801164303882524758454);
        fuzz_admin_wt_settleRedeem(531805);
    }

    function test_repro_32() public {
        vm.warp(block.timestamp + 38812);
        vm.roll(block.number + 1311);
        try
            this.fuzz_admin_router7540_requestAsyncWithdrawal(
                14,
                5730368980593473517993357088859897993824186957866074460861780541009729
            )
        {} catch {}
        vm.warp(block.timestamp + 155762);
        vm.roll(block.number + 3831);
        try this.fuzz_nodeFactory_deploy(10265290076423423503028079841577509) {} catch {}
        vm.warp(block.timestamp + 84407);
        vm.roll(block.number + 82);
        try
            this.fuzz_admin_router4626_fulfillRedeem(
                0,
                2638702189470576954110488490047429034450789146904735057077346052267251
            )
        {} catch {}
        vm.warp(block.timestamp + 704048);
        vm.roll(block.number + 6787);

        vm.warp(block.timestamp + 281447);
        vm.roll(block.number + 51);
        try
            this.fuzz_admin_router4626_invest(
                47935887152536069481082275843447797632028023738438158036371357448487,
                0
            )
        {} catch {}
        vm.warp(block.timestamp + 879056);
        vm.roll(block.number + 256);

        vm.warp(block.timestamp + 181044);
        vm.roll(block.number + 620);
        try this.fuzz_nodeFactory_deploy(1479769577680151612458) {} catch {}
        vm.warp(block.timestamp + 278);
        vm.roll(block.number + 6);
        try
            this.fuzz_guided_router7540_partialFulfill(
                620631629,
                88413234331484132997008647418833313295268236935015778846153584762159627300818,
                35570013827703777209363147555006974419692338111375169905865258821392650407739
            )
        {} catch {}
        vm.warp(block.timestamp + 278);
        vm.roll(block.number + 3502);
        try
            this.fuzz_guided_router7540_partialFulfill(
                1524785993,
                88413234331484132997008647418833313295268236935015778846153584762159627300818,
        ...
        try
            this.fuzz_guided_router7540_partialFulfill(
                1200838692,
                2839450081872440204713834383407183015385388242122324031517635292566017560,
                64707384642309961966858897588864101318662319758480929035637226780946555
            )
        {} catch {}
        vm.warp(block.timestamp + 278);
        ...
        this.fuzz_guided_router7540_partialFulfill(
            1524785993,
            64418085078740830810434874078236041191867608210503500787466507120233234985286,
            35570013827703777209363147555006974419692338111375169905865258821392650407739
        );
    }
}
