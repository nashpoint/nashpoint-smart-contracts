...
**Generated:** 2025-11-06 14:18:27
**Coverage File:** `echidna-corpus/covered.1762434275.txt`
**Timestamp:** 1762434275
...
| 🟡 **ERC7540Router** | 64.29% | ❌ Fail | 10 | [View](#erc7540router) |
...
```solidity
❌ Warning: Coverage 64.29% below threshold 70%
```
...
- **ERC7540Router**: Needs 5.71% improvement (current: 64.29%)
