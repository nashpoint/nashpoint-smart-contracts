...
## Deposits & Mints
The main logic is on Node.sol. A Node is an async withdrawal ERC-7540 vault. Deposits follow a standard ERC-4626 interface. Users deposit assets to receive shares that are a pro-rata receipt for their holdings in the node contract.
