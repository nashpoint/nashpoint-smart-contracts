...
// source .env && FOUNDRY_PROFILE=deploy forge script script/sepolia/DigiftMintTesting.s.sol:DigiftMintTesting --rpc-url ${ETH_SEPOLIA_RPC_URL} -vvv --broadcast --legacy --with-gas-price 10000000000

contract DigiftMintTesting is Script {
